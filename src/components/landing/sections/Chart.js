...
const HeroChart = () => {
  ...
  useEffect(() => {
    ...
    // (Equivalent to componentDidMount and componentDidUpdate in class components)
...
// Note: You may need to adjust any other parts of your code related to ReactDOM.render
