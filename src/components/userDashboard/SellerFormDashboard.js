...
import { startTrade } from "store/actions";
import Modal from "components/_common/modal/Modal";
import TradeStartModal from "./TradeStartModal";

function SellerFormDashboard({ bid }) {
        ...
        <div className="shadow-sm flex flex-col gap-5 justify-center border p-8 rounded-md bg-white">
          ...
          <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-5">
            <div className="w-full flex flex-col justify-start gap-2">
              <label className="">I will receive</label>
            ...
            <div className="w-full flex flex-col justify-start gap-2">
              <label className="">and pay in PKRD</label>
              <div className="flex flex-row gap-2 border rounded-md">
                <input
                  disabled
                  value={
          ...
          {/* <p className="w-full text-center">
            Reserve PKRD for this trade and start live chat with{" "}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <div className="w-full flex flex-col gap-3">
            ...
            <div className="shadow-sm border rounded-md py-5 px-6 bg-white flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-1">
                <p className="text-[#848484]">Sell limits</p>
                <p className="text-xl font-bold">
                  <span className="text-[#848484] font-bold">Min</span>  {bid?.minAmount}
                  USD - <br className="sm:hidden" />{" "}
                  <span className="text-[#848484] font-bold">Max</span> {bid?.maxAmount}
                  USD
                </p>
              </div>
...
export default SellerFormDashboard;
